    ...
    <div class="container-fluid">
      ...
      <ol class="breadcrumb">
        <li class="breadcrumb-item">
          <a href="userindex.php">Dashboard</a>
        </li>
...
<select class="form-control" name="Dname">
    <?php 
    $query ="SELECT device_name FROM devices";
...
continue;
   ...
   <div class="form-group">
    ...
    <input type="number" class="form-control"  name="Dcustomer" required >
  </div>
   <div class="form-group">
    <label>Mpesa code</label>
    <input type="text" class="form-control"  name="Dmpesa" required>
  </div>
...
<select class="form-control" name="Dshop">
    ...
    $query ="SELECT shop_name as shop FROM users where username= '$usern' ";
    $result = $conn->query($query);
    if($result->num_rows> 0){
        while($optionData=$result->fetch_assoc()){
