...
class PDF_reciept extends FPDF {
    ...
    function Header() {
        ...
        $this->Cell(0, 30, "SmartechKe Store", 0, 1, 'C', true);
    }
    ...
    function Footer() {
        ...
        $this->SetTextColor(0);
        $this->SetXY(0,-60);
        $this->Cell(0, 20, "Thank you for shopping with us", 'T', 0, 'C');
    }
    ...
    function PriceTable($products, $prices) {
        ...
        for ($i = 0; $i < count($products); $i++) {
            ...
            $this->Cell(50, 10, 'KES ' . $prices[$i], 1, 1, 'R', $fill);
            $fill = !$fill;
        }
        $this->SetX(50);
        $this->Cell(30, 10, "Total", 1);
        $this->Cell(50, 10, 'KES ' . array_sum($prices), 1, 1, 'R');
    } 
}
...
$pdf->Ln(30);
$pdf->Write(13, "smartechke@gmail.com", "example:example@example.com");
