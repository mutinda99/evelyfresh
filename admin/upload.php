...
<body class="fixed-nav sticky-footer bg-dark" id="page-top">
  ...
  <div class="content-wrapper">
    <div class="container-fluid">
      ...
      <div class="row">
        <div class="col-12">
          <h1>Upload Devices Stock </h1>
		  <a href="devices_sampleCsv.csv">Download Sample CSV</a>
        </div> 
	...
	<div class="container">
		<div class="row">
			...
			<div class="span6" id="form-login">
				<form class="form-horizontal well" action="uploads.php" method="post" name="upload_excel" enctype="multipart/form-data">
					<fieldset>
						...
						<div class="control-group">
							<div class="controls">
							<button type="submit" id="submit" name="uploads" class="btn btn-primary button-loading" data-loading-text="Loading...">Upload</button>
							</div>
						</div>
					</fieldset>
				</form>
